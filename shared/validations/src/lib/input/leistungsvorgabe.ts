...
export const LeistungsvorgabeGarantierteMindestrenteSchema = z.literal('Garantierte Mindestrente');
export const LeistungsvorgabeGarantiekapitalSchema = z.literal('Garantiekapital');
